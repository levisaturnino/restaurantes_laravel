...
<form action="{{route('user.update',['id'=>$user->id])}}" method="GET">
    ...
    <p class="form-group">
        ...
        <input type="text" name="name" value="{{old('name',$user->name)}}" class="form-control @if($errors->has('name'))is-invalid @endif">
        @if($errors->has('name'))
    ...
    <p class="form-group">
        ...
        <input type="text" name="email" value="{{old('email',$user->email)}}" class="form-control @if($errors->has('email'))is-invalid @endif">
